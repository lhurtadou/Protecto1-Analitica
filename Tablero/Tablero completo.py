...
# Callback para actualizar el resultado de la simulación de rentabilidad
@app.callback(
    ...
    [Input('temperatura', 'value'),
     ...
     Input('mes', 'value'),
     Input('num_bicicletas', 'value')]
)
def update_output(temperatura, humedad, hour, wind_speed, visibility, dew_point, 
                  solar_radiation, rainfall, snowfall, seasons, dia_semana, mes, num_bicicletas):
    return update_output_div(temperatura, humedad, hour, wind_speed, visibility, dew_point, 
                             solar_radiation, rainfall, snowfall, seasons, dia_semana, mes, num_bicicletas)
